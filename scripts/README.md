...
GitHub OIDC tokens can impersonate the Packer service account only for this repository when running on `master` or when the job runs through the `cloud-test` GitHub Environment.
